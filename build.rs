...
fn build_linux() {
    ...
    println!("{}", freeimage_copy.to_str().unwrap());

    let output = Command::new("patch")
        .arg("-p1")
        .arg("-i")
        .arg("patches/freeimage-unbundle.patch")
        .current_dir(&freeimage_copy)
        .output()
        .unwrap();
    ...
    let output = Command::new("rm")
        .arg("Source/FreeImage/PluginG3.cpp")
        .current_dir(&freeimage_copy)
        .output()
        .unwrap();
    ...
    let output = Command::new("rm")
        .arg("Source/FreeImageToolkit/JPEGTransform.cpp")
        .current_dir(&freeimage_copy)
        .output()
        .unwrap();
    ...
    let output = Command::new("patch")
        .arg("-p1")
        .arg("-i")
        .arg("patches/freeimage-libraw-0.20.patch")
        .current_dir(&freeimage_copy)
        .output()
        .unwrap();
    ...
    let output = Command::new("patch")
        .arg("-p1")
        .arg("-i")
        .arg("patches/freeimage-libraw-0.21.patch")
        .current_dir(&freeimage_copy)
        .output()
        .unwrap();
